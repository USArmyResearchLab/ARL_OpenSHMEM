...
define(decl_shmem_get_x_nbi,
`void shmem_get$1_nbi( void *dest, const void *source, size_t nelems, int pe);'
)

define(func_shmem_get_x_nbi,
`void shmem_get$1_nbi( void *dest, const void *source, size_t nelems, int pe)
{
	shmemx_memcpy((void*)dest, shmem_ptr(source,pe), nelems * sizeof($2) );
}'
)
